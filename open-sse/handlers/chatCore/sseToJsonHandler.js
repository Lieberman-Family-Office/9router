...
function chatCompletionToResponses(responseBody, customToolNames = null, asyncToolNames = null) {
 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, targetFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, clientRawRequest, onRequestSuccess, customToolNames, asyncToolNames, trackDone, appendLog, reqTag, log }) {
  ...
  try {
    ...
    const finalBody = sourceFormat === FORMATS.OPENAI_RESPONSES
      ? chatCompletionToResponses(parsed, customToolNames, asyncToolNames)
      : parsed;
