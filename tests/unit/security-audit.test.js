...
// Source paths are repo-root relative; resolve them from this file, not the cwd
// (vitest runs from tests/, where "src/..." does not exist).
const REPO_ROOT = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
const src = (rel) => path.join(REPO_ROOT, rel);
